...
void Forward(){
    ...
    if (startDistance <= TileDistance+3){
        Serial.println("error cant drive forward, object is too close");
        return;      
    } 
    do{
      analogWrite(EN1, motorSpeed);      //sets the motors speed
    ...
    }while(stopDistance > startDistance-TileDistance);
